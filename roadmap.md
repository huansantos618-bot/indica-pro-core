...
Regra: SÓ ACRÉSCIMO. Nunca alterar/remover tabelas ou colunas existentes.

## Concluído
- Banco (fundação + tabelas auxiliares), storage `public-media`, logo/favicon
- Landing, login, painéis empresa/indicador/admin (base)
